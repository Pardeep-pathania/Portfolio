      ...
      md:px-20'>
        <span className='text-2xl font-bold tracking-wide'>Pardeep's Portfolio</span>
            ...
            text-center md:bg-transparent md:static md:mx-0 md:flex gap-6`}>
              ...
              <a href="">
              <li className='text-md transition-all duration-300 p-1 med:p-0'>About</li>
              </a>
               
               <a href="">
               <li className='text-md transition-all duration-300 p-1 med:p-0'>Experience</li>
               </a>
               
               <a href="">
               <li className='text-md transition-all duration-300 p-1 med:p-0'> Projects</li>
               </a>
                
                <a href="">
                <li className='text-md transition-all duration-300 p-1 med:p-0'>Contact</li>
                </a>
                
            </ul>

            {showMenu ? (
              <RiMenu2Line size={30} className='md:hidden right-10 top-6 transition-all duration-300' onClick={()=>{
